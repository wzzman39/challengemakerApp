...
export const STRINGS = {
  ru: {
    ...
    language: "Язык",
    theme_hud: "HUD",
    theme_journal: "Полевой журнал",
    theme_terminal: "Терминал",
    ...
    summon_challenge: "🎲 Вызвать челлендж",
    randomize: "🎲 Случайно",
    current: "ТЕКУЩИЙ",
  ...
  en: {
    ...
    summon_challenge: "🎲 Summon challenge",
    randomize: "🎲 Randomize",
    current: "CURRENT",
    reward_label: "Reward:",
  ...
  de: {
    ...
    summon_challenge: "🎲 Challenge beschwören",
    randomize: "🎲 Zufällig",
    current: "AKTUELL",
